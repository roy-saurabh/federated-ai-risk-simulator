...
<style>
    ...
    /* Dark theme support for main header */
    ...
    .stApp[data-theme="dark"] .metric-card h4 {
        color: #f1f5f9 !important;
    }
    [data-theme="dark"] .metric-card h2,
    .stApp[data-theme="dark"] .metric-card h2 {
        color: #f1f5f9 !important;
    }
    [data-theme="dark"] .metric-card small,
    .stApp[data-theme="dark"] .metric-card small {
    ...
    /* Improve contrast for Streamlit info boxes in dark theme */
    ...
    /* Ensure text in info boxes is visible */
    [data-theme="dark"] .stAlert > div,
    .stApp[data-theme="dark"] .stAlert > div {
        color: #f1f5f9 !important;
    }
    [data-theme="dark"] .stAlert p,
    .stApp[data-theme="dark"] .stAlert p {
        color: #f1f5f9 !important;
    }
    [data-theme="dark"] .stInfo p,
    .stApp[data-theme="dark"] .stInfo p {
        color: #f1f5f9 !important;
    }
    /* Improve table visibility in dark theme */
    ...
    /* Additional dark theme support using Streamlit's class-based approach */
